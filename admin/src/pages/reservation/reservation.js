                        ...
                        <div class="col-md-12">
                            ...
                            <div class="x_content">
                                ...
                                <div class="row">
                                    ...
                                    <p class="text-muted well well-sm no-shadow" style={{margin: '10px'}}>
                                ...
                                <div class="row no-print">
                                    ...
                                    <button class="btn btn-primary pull-right" style={{margin: '5px'}}><i class="fa fa-download"></i> Generate PDF</button>
                                    </div>
                                </div>
                                </section>
                            </div>
